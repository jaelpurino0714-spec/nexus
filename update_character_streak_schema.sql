-- ============================================================================
-- NEXUS: INTERACTIVE CHARACTER & STREAK COMPANION SCHEMA EXTENSION
-- ============================================================================
...
COMMENT ON COLUMN public.profiles.character_xp IS 'Total accumulated companion XP';
...
COMMENT ON COLUMN public.profiles.longestStreak IS 'All-time maximum streak count';
