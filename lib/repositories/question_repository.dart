...
abstract class QuestionRepository {
  Future<List<PreparedQuestion>> getPreparedQuestionsForQuiz(String topicId);
...
class QuestionRepositoryImpl implements QuestionRepository {
  ...
  @override
  Future<List<PreparedQuestion>> getPreparedQuestionsForQuiz(String topicId) async {
    final rawQuestions = await _questionService.fetchActiveQuestionsByTopic(topicId);
